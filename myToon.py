...
inputImage = cv2.imread('input_images/download.jpeg')
...
cv2.imwrite('output_images/1.jpeg',medianFiltered)
# cv2.waitKey(0)
...
cv2.imwrite('output_images/2.jpeg',edgesDetected)
# cv2.waitKey(0)
# cv2.destroyAllWindows()
...
cv2.imwrite('output_images/3.jpeg',dilatedImage)
# cv2.waitKey(0)
# cv2.destroyAllWindows()
...
cv2.imwrite('output_images/4.jpeg',thresholdedImage)
# cv2.waitKey(0)
# cv2.destroyAllWindows()
#cv2.imwrite('output/10.jpeg',hierarchy)
cv2.imwrite('output_images/5.jpeg',image)
cv2.imwrite('output_images/6.jpeg',invertedEdges)
#################################### Part 1 Completed ##################################################
########################################################################################################
#################################### Color Quantization ################################################
...
cv2.imwrite('output_images/7.jpeg',downsampledImage)
# cv2.waitKey(0)
# cv2.destroyAllWindows()
...
cv2.imwrite('output_images/8.jpeg',downsampledImage)
...
cv2.imwrite('output_images/9.jpeg',linearInterpolatedImage)
# cv2.waitKey(0)
# cv2.destroyAllWindows()
...
cv2.imwrite('output_images/10.jpeg',medianFilteredImage)
# cv2.waitKey(0)
# cv2.destroyAllWindows()
...
cv2.imwrite('output_images/11.jpeg',medianFilteredImage)
# cv2.waitKey(0)
# cv2.destroyAllWindows()
...
cv2.imwrite('output_images/12.jpeg', toonifiedImage)
cv2.imshow('Toonified',toonifiedImage)
cv2.waitKey(0)
cv2.destroyAllWindows()
